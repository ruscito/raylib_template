...
RAYLIB_PATH        ?= /Users/agostino/Library/raylib/
...
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external -I /includes 
...
SRC:=$(wildcard scr/*.c)
# AR:  OBJS = $(patsubst %.c, %.o, $(PROJECT_SOURCE_FILES))
OBJS:=$(SRC:scr/%.c=obj/%.o)
